...
@implementation HTUnitTagAutocompleteTextField
              ...
              ignoreCase:(BOOL)ignoreCase
{
    ...
    for (NSString *stringFromReference in self.unitTags) {
        NSString *stringToCompare = (ignoreCase) ? [stringFromReference lowercaseString] : stringFromReference;
        
        if ([stringToCompare hasPrefix:stringToLookFor]) {
            return [[stringFromReference stringByReplacingCharactersInRange:[stringToCompare rangeOfString:stringToLookFor] withString:@""] uppercaseString];
        }
